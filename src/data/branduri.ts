...
export const BRANDURI: Record<string, Brand> = {
  samsung: {
    ...
    sectiuni: [
      ...
      ['Ce puteți verifica singur înainte să ne sunați', [
        ...
        'Dacă aparatul nu dă niciun semn la priză sau face un clic repetat din spate, verificările din meniu nu vă ajută — acolo e vorba de alimentare, iar cazul este explicat pas cu pas pe pagina <a href="/televizorul-samsung-nu-se-aprinde/">televizorul Samsung nu se aprinde</a>.',
  ...
  lg: {
    ...
    nume: 'LG',
    titlu: 'Reparații TV LG București – Service OLED la Domiciliu',
  ...
  sony: {
    ...
    descriere: 'Service televizoare Sony Bravia la domiciliu în București și Ilfov: OLED, LED 4K, Google TV. Deplasare și diagnosticare gratuite, garanție 6–12 luni.',
  ...
  philips: {
    ...
    nume: 'Philips',
    titlu: 'Reparații TV Philips – Service Ambilight la Domiciliu',
  ...
  horizon: {
    ...
    descriere: 'Service televizoare Horizon la domiciliu în București și Ilfov: Smart TV, LED, 4K UHD. Deplasare și diagnostic gratuite, garanție 6–12 luni.',
